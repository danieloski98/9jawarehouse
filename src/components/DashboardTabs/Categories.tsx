        ...
        <div className='w-full py-10 px-10' >
            <div className='w-full flex items-center' > 
                ...
                <div className='ml-auto'>
                    <button onClick={()=> setShowModal(true)} style={{backgroundColor: '#1A8F85'}} className='px-4 py-3 font-Graphik-Regular text-sm text-white flex items-center rounded-md ml-4' >+ New category</button>
                </div>
            </div> 
