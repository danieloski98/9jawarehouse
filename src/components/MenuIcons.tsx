...
export default function Icons(props: any) {
    return(
        <>
            {props.icons === 'Overview' && props.index !== 'Overview' ?
            ...
            {props.icons === 'Activity' && props.index !== 'Activity' ?
            ...
            {props.icons === 'Vendors' && props.index !== 'Vendors' ?
            ...
            {props.icons === 'Categories' && props.index !== 'Categories' ?
            ...
            {props.icons === 'Subscriptions' && props.index !== 'Subscriptions' ?
            ...
            {props.icons === 'Role Management' && props.index !== 'Role Management' ?
            ...
            {props.icons === 'Account Settings' && props.index !== 'Account Settings' ?
