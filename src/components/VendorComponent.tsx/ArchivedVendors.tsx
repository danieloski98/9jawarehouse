import { Input, Select, Table, Thead, Tr, Th, Tbody, Td, useToast } from '@chakra-ui/react'
        ...
        <div className='w-full py-10 px-10' >
            <div className='w-full flex' >   
                ...
                <div className=''>
                    ...
                    <p style={{color: '#8A8A8A'}} className='text-sm font-Graphik-Regular' >Showing customers with deactivated profiles.</p>
                </div> 
            </div> 
