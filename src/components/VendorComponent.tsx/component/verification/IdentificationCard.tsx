    ...
    return (
        <>
            ...
            <div style={{ height: '279px', background: '#F6F6F6 0% 0% no-repeat padding-box', border: '1px solid #ECECEC'}} className='flex justify-center items-center w-full' >
                <div style={{width: '663px', height: '244px', borderRadius: '5px'}} className=' bg-yellow-300 overflow-hidden rounded-md' >
                    {img !== '' && <img src={img} alt="img" className='w-full h-full cursor-pointer' />}
                    {img === '' && (
