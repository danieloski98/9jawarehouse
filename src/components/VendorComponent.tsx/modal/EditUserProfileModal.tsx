...
export default function EditUserProfileModal(props: any) {
    return (
        <div style={{width: '960px', height: '920px'}} className='bg-white rounded-lg px-10 py-4 pb-14'  > 
            ...
            <div className='w-full flex' >
                <div className='w-full mr-10' >
                    <div className='my-4 pt-4 w-full' >
                        ...
                        <Input size='lg' fontSize='sm' placeholder="jjs@gmail.com" />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
                    ...
                    <div className='my-4 pt-4 w-full' >
                        ...
                        <Input size='lg' fontSize='sm' placeholder="+234" />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
                        <p className='text-sm mb-1 font-Graphik-Medium '>City</p> 
                        <Input size='lg' fontSize='sm' placeholder="Enter city" />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
                        <p className='text-sm mb-1 font-Graphik-Medium '>Service</p> 
                        <Select size='lg' fontSize='sm' placeholder="Choose catergory" />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
                ...
                <div className='w-full ml-10' >
                    <div className='my-4 pt-4 w-full' >
                        ...
                        <Textarea size='lg' fontSize='sm' placeholder="jjs@gmail.com" height='145px' />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
                        <p className='text-sm mb-1 font-Graphik-Medium '>Business address</p> 
                        <Input size='lg' fontSize='sm' placeholder="Enter House address" />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
                        <p className='text-sm mb-1 font-Graphik-Medium '>State</p> 
                        <Input size='lg' fontSize='sm' placeholder="Enter state" />
                    </div> 
                    <div className='my-4 pt-4 w-full' >
            ...
            <button style={{backgroundColor: '#1A8F85'}} className='w-full py-3 font-Graphik-Bold text-sm text-white rounded-md mt-8' >Update Information</button>
                </div>
            </div>
        </div>
    )
