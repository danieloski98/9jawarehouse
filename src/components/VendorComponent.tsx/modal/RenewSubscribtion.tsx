...
export default function RenewSubscribtion(props: any) {
    return (
        <div style={{width: '416px'}} className='bg-white rounded-lg px-10 py-4 pb-14'  > 
            <div className='w-full flex items-center' >
                <p className='font-Graphik-SemiBold mt-6' style={{color:'#0C0C0C'}} >Renew Subscribtion</p> 
            ...
            <button style={{backgroundColor: '#1A8F85'}} className='w-full py-3 font-Graphik-Bold text-sm text-white rounded-md mt-8' >Renew</button>
        </div>
    )
}
