               ...
               <>
                        ...
                        {user.blocked && (
                            <div className="w-full xl:h-20 lg:h-20 md:h-40 sm:h-40 bg-red-300 flex xl:flex-row lg:flex-row md:flex-col sm:flex-col justify-center items-center xl:mt-20 lg:mt-20 md:mt-16 sm:mt-16">
                                ...
                                {user.verification_document === "" ? <p className="text-white font-bold sm:px-4 sm:text-center">For your account to be visible to the public, upload a verification document.</p> : <p className="text-white font-bold">Your account is currently under review.</p>}
