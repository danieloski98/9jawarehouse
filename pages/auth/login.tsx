        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 xl:pl-10 lg:pl-10 md:pl-5 sm:pl-5 xl:pr-0 lg:pr-0 md:pr-5 sm:pr-5 flex flex-col justify-center items-start">
                ...
                <div className="xl:w-4/6 lg:w-4/6 md:w-full sm:w-full text-center">
                    <p className="text-sm font-light mt-12 text-center text-gray-500 cursor-pointer">Dont have an account? <span className="text-themeGreen" onClick={() => router.push('/auth/createaccount')}>Create Account</span></p>
                </div>
            </div>
        </div>
