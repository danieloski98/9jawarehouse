    ...
    <Modal isOpen={open} onClose={() => close()} isCentered size="xl" closeOnEsc={false} closeOnOverlayClick={false}>
        ...
        <ModalContent>
            <ModalBody className='w-full h-full flex justify-center items-center flex-col py-10'>
                    ...
                    <p className='font-light mt-5'>If an account exist with this email, a verification code has been sent to it.</p>
                    <Link href="/auth/resetpassword" passHref >
                        <button className="xl:w-4/6 lg:w-4/6 md:w-full sm:w-full mt-8 h-12 bg-themeGreen cursor-pointer flex justify-center items-center mb-10">
                            <span className="ml-4 text-sm font-semibold text-white">Reset Password</span>
                        </button>
                    </Link>
            </ModalBody>
        </ModalContent>
    ...
    return (
        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 xl:pl-10 lg:pl-10 md:pl-5 sm:pl-5 xl:pr-0 lg:pr-0 md:pr-5 sm:pr-5 flex flex-col justify-center items-start">
                <h3 className="text-3xl font-semibold text-gray-700">Forgot Your Password</h3>
                <p className="text-sm font-light mt-4 text-gray-500">Lets help you retrieve your password</p>
