        ...
        <div className="w-full flex flex-col items-center">
            <div className="xl:w-4/5 lg:w-4/5 md:w-full sm:w-full h-auto flex flex-col py-6 xl:px-0 lg:px-0 md:px-5 sm:px-5">
                ...
                <div className="w-full flex flex-col">
                    <p className="text-4xl font-light text-themeGreen">About 9jaWarehouse</p>
                    <p className="mt-2 font-semibold text-gray-500 text-justify">We are a business platform that helps link businesses services to potential clients, give businesses visibility, support, young and emerging entrepreneurs, invest, support, and promote small scale businesses. 
                    </p>
                </div>

                <div className="w-full flex flex-col mt-8">
                    <p className="text-4xl font-light text-themeGreen">Mission</p>
                ...
                <div className="w-full flex flex-col mt-8 xl:items-start lg:items-start md:items-center sm:items-center ">
                    <p className="text-4xl font-light text-themeGreen">Meet the Team</p>
                    <div className="w-full grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 mt-6">
                        ...
                        <div className="flex-col flex xl:w-64 lg:w-64 md:w-full sm:w-full items-center">
                           ...
                           <p className="text-center font-light text-lg mt-2">Mr. John Asiruwa</p>
                           <p className="mt-0 text-center font-semibold text-sm">Founder / CEO</p>
                        </div>
