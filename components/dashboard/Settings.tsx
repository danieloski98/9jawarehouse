        ...
        <div className="xl:w-5/6 lg:w-5/6 md:w-full sm:w-full xl:ml-5 lg:ml-5 md:ml-0 sm:ml-0 mt-6 py-8 flex-col">
            ...
            <div className="xl:w-2/4 lg:w-2/4 md:w-full sm:w-full flex flex-col mt-4">
                ...
                <InputGroup>
                    ...
                    <Input type={show1 ? 'text':'password'} border="none" bgColor="whitesmoke" borderRadius={0} className="bg-gray-100 mt-3 " name="oldpassword" onChange={formik.handleChange} onBlur={formik.handleBlur} onFocus={() => formik.setFieldTouched('oldpassword', true, true)} />
                </InputGroup>
                {
                    formik.touched.oldpassword && formik.errors.oldpassword && (
                        <p className='mt-1 text-red-500 text-xs font-light'>{formik.errors.oldpassword}</p>
                    )
                }
            </div>
            ...
            <div className="xl:w-2/4 lg:w-2/4 md:w-full sm:w-full flex flex-col mt-4">
                ...
                <InputGroup>
                    ...
                    <Input type={show2 ? 'text':'password'} border="none" bgColor="whitesmoke" borderRadius={0} className="bg-gray-100 mt-3" name="newpassword" onChange={formik.handleChange} onBlur={formik.handleBlur} onFocus={() => formik.setFieldTouched('newpassword', true, true)} />
                </InputGroup>
                {
                    formik.touched.newpassword && formik.errors.newpassword && (
                        <p className='mt-1 text-red-500 text-xs font-light'>{formik.errors.newpassword}</p>
                    )
                }
            </div>

            <button onClick={submit} className="w-1/4 mt-4 h-12 p-3 text-sm text-white font-semibold bg-themeGreen">
